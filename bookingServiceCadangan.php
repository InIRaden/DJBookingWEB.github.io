...
if (isset($_POST['submit'])) {
    ...
    if ($LastInsertId > 0) {
        ...
        $_SESSION['payment_info'] = [
            ...
            'va_number' => mt_rand(1000000000000000, 9999999999999999) // Generate random VA number
        ];

        // Don't redirect, JavaScript will handle the modal display
...
<div id="cash-modal" class="modal">
    <div class="modal-content">
        <span class="close-modal" onclick="closeModal('cash-modal')">&times;</span>
        ...
        <div class="p-4">
            ...
            <div class="bg-gray-700 p-4 rounded-lg mb-4">
                ...
                <div class="copy-field">
                    <input type="text" id="transfer-va-number" value="<?php echo isset($_SESSION['payment_info']) ? $_SESSION['payment_info']['va_number'] : ''; ?>" readonly>
...
<div id="installment-modal" class="modal">
    <div class="modal-content">
        <span class="close-modal" onclick="closeModal('installment-modal')">&times;</span>
        <div class="modal-header">
        ...
        <div class="p-4">
            ...
            <div class="bg-gray-700 p-4 rounded-lg mb-4">
                <p class="text-white mb-2">Virtual Account Number:</p>
                <div class="copy-field">
                    <input type="text" id="installment-va-number" value="<?php echo isset($_SESSION['payment_info']) ? $_SESSION['payment_info']['va_number'] : ''; ?>" readonly>
