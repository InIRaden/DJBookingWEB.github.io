...
<body class="bg-black text-white">
	...
	<header class="relative">
		<img alt="DJ performing at event" class="w-full h-[300px] object-cover" src="images/headerContact.jpg" />
		...
		<div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center max-w-md px-4">
			<h1 class="text-white font-bold text-lg md:text-xl leading-tight">Contact Us</h1>
			<p class="text-xs md:text-sm mt-2 text-white">
				Get in touch with our team for any inquiries or booking information
			</p>
		</div>
	</header>
