...
<body class="bg-black text-white">
    ...
    <header class="relative">
        ...
        <nav class="absolute top-0 left-0 w-full flex items-center justify-between px-6 py-4 text-white">
            ...
            <ul class="hidden md:flex space-x-8 text-sm font-normal">
                ...
                <li><a class="hover:underline" href="admin/">Admin</a></li>
            </ul>
        ...
        <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center max-w-md px-4">
            ...
            <a href="book-dj.php" class="mt-3 inline-block bg-red-700 text-white text-xs font-semibold px-3 py-1 rounded hover:bg-red-600 transition">
                Buy Ticket Now
            </a>
        </div>
    </header>
