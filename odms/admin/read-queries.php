...
?>
    ...
    <head>
        ...
        <title>Online DJ Management System - Read Queries</title>
                ...
                <div class="content">
                    ...
                    <div class="table-card">
                        <div class="table-header">
                            <h3 class="table-title">Read Queries</h3>
                        </div>
                                        ...
                                        foreach ($results as $row) {               ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="read-queries.php?delid=<?php echo ($row->ID); ?>" onclick="return confirm('Do you really want to Delete ?');" class="btn btn-danger btn-sm">Delete</a>
                                                </td>
                                            </tr>
                                    <?php $cnt = $cnt + 1;
                                        }
