        ...
        GMaps.geocode({
          ...
          callback: function (results, status) {
            if (status === "OK" && results) {
              ...
              inputGroup.after(
                '<div class="form-text text-danger text-xs-center animated fadeInDown">Address not found!</div>'
              );
            }
          },
        });
  ...
  var initMapOverlay = function () {
    if (jQuery("#js-map-overlay").length) {
      new GMaps({
        ...
        lng: 139,
        content:
          '<div class="alert alert-info text-xs-center"><h4 class="alert-heading mt-5 mb-15">Message</h4><p class="font-size-h5 mb-0">You can overlay messages on your maps!</p></div>',
      });
    }
  };
    ...
    if (jQuery("#js-map-markers").length) {
      new GMaps({
      ...
      }).addMarkers([
        {
          ...
          infoWindow: { content: "Map Marker #1" },
        },
        {
          lat: 35.71,
          lng: 139.89,
          title: "Map Marker #2",
          animation: google.maps.Animation.DROP,
          infoWindow: { content: "Map Marker #2" },
        },
        {
          lat: 35.68,
          lng: 139.8,
          title: "Map Marker #3",
          animation: google.maps.Animation.DROP,
          infoWindow: { content: "Map Marker #3" },
        },
        {
          lat: 35.63,
          lng: 139.88,
          title: "Map Marker #4",
          animation: google.maps.Animation.DROP,
          infoWindow: { content: "Map Marker #4" },
        },
        {
          lat: 35.7,
          lng: 139.85,
          title: "Map Marker #5",
          animation: google.maps.Animation.DROP,
          infoWindow: { content: "Map Marker #5" },
        },
      ]);
    }
  };
