    ...
    <div class="content-header" style="background-color: #1a1f2e; box-shadow: 0 0.5rem 1rem rgba(0,0,0,.15);">
        ...
        <div class="content-header-section">
            ...
            <div class="btn-group" role="group">
                <button type="button" class="btn btn-circle btn-dual-secondary" id="page-header-options-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <i class="fa fa-wrench" style="color: #e0e0e0;"></i>
                </button>
                <div class="dropdown-menu dropdown-menu-dark" aria-labelledby="page-header-options-dropdown" style="background-color: #252b3b; color: #e0e0e0; border: 1px solid #2d3446;">
                    <h6 class="dropdown-header" style="color: #4f9fff;">Header</h6>
                    <button type="button" class="btn btn-sm btn-block btn-alt-secondary" data-toggle="layout" data-action="header_fixed_toggle" style="color: #e0e0e0;">Fixed Mode</button>
                    <button type="button" class="btn btn-sm btn-block btn-alt-secondary d-none d-lg-block mb-10" data-toggle="layout" data-action="header_style_classic" style="color: #e0e0e0;">Classic Style</button>
                    <div class="d-none d-xl-block">
                        <h6 class="dropdown-header" style="color: #4f9fff;">Main Content</h6>
                        <button type="button" class="btn btn-sm btn-block btn-alt-secondary mb-10" data-toggle="layout" data-action="content_layout_toggle" style="color: #e0e0e0;">Toggle Layout</button>
                    </div>
            ...
            <div class="btn-group" role="group">
                <button type="button" class="btn btn-circle btn-dual-secondary" id="page-header-themes-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <i class="fa fa-paint-brush" style="color: #e0e0e0;"></i>
                </button>
                <div class="dropdown-menu dropdown-menu-dark min-width-150" aria-labelledby="page-header-themes-dropdown" style="background-color: #252b3b; color: #e0e0e0; border: 1px solid #2d3446;">
                    <h6 class="dropdown-header text-center" style="color: #4f9fff;">Color Themes</h6>
        ...
        <div class="content-header-section">
            ...
            <div class="btn-group" role="group">
                ...
                ?>
                <button type="button" class="btn btn-rounded btn-dual-secondary" id="page-header-user-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="color: #e0e0e0;">
